...
#         scale_x_continuous(
#           # Explicitly set the lower limit to include space for the annotation
#           limits = c(min(data$adjusted_rank) - 2, as.numeric(k)),
#           expand = c(0.02, 0.02)
#         ) +
#         scale_y_reverse(
...
#           color = "Weighting"
#         ) +
#         geom_hline(yintercept = c(0, 0.1), linetype = "dashed", color = "black", linewidth = 0.5) +
...
#           plot.margin = margin(5.5, 40, 5.5, 40, "pt")
#         ) +
